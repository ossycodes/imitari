...
describe("Downloading image", () => {
    ...
    it("should be able to to add image effects as we request", (done) => {
        chai
            .request(tools.service)
    ...
    it("should be able to resize the image height as we request", (done) => {
        chai
            .request(tools.service)
            .get("/uploads/test_image_download.png?height=300")
            .end((err, res) => {
                chai.expect(res).to.have.status(200);
                ...
                image
                    .metadata()
                    .then((metadata) => {
                        chai.expect(metadata).to.have.property("height", 300)
